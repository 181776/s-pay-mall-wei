package com.wei.mall.cart.service.impl;
...
import com.wei.mall.cart.mapper.CartMapper;
...
public class CartServiceImpl extends ServiceImpl<CartMapper, Cart> implements ICartService {
    ...
    @Override
    public void removeByItemIds(CartClearMessage cartClearMessage) {
        // 1.构建删除条件，userId和itemId
        QueryWrapper<Cart> queryWrapper = new QueryWrapper<Cart>();
        queryWrapper.lambda()
                .eq(Cart::getUserId, cartClearMessage.getUserId())
                .in(Cart::getItemId, cartClearMessage.getItemIds());
        // 2.删除
        remove(queryWrapper);
    }
